...
open_color_typed = '[color='i ('gen'i('eral'i)?|'art'i('ist'i)?|'fet'i('ish'i)?|'oc'i|'ch'i('ar'i('acter'i)?)?|'co'i('py'i('right'i)?)?|'spec'i('ies'i)?|'inv'i('alid'i)?|'meta'i|'lor'i('e'i)?|'gender'i|'g'i('eneral'i)?'a'i('dult'i)?) >mark_a1 %mark_a2 ']';
